...
public class AdapterGridProductosVendedorCliente extends RecyclerView.Adapter<AdapterGridProductosVendedorCliente.ViewHolder> {
    ...
    public AdapterGridProductosVendedorCliente(
            Context context,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterGridProductosVendedorCliente.ViewHolder viewHolder = new AdapterGridProductosVendedorCliente.ViewHolder(vistaMensaje);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        btnEditarProductoItemProductosVendedor.setVisibility(View.GONE);
        btnEliminarProductoItemProductosVendedor.setVisibility(View.GONE);
