...
public class FragmentoListarProductos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragmento_producto, container, false);
        ...
        gridProductosVendedor = root.findViewById(R.id.gridProductosVendedor);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    adapterGridProductosVendedor = new AdapterGridProductosVendedor(getContext(),
                            ...
                            storage,
                            getActivity(),
                            "listaProductos",databaseReference);
                    gridProductosVendedor.setAdapter(adapterGridProductosVendedor); //configuramos el view
